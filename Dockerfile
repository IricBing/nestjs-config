...
# 用作报警相关的redis数据库
ENV REDIS_ALARM_NAME=alarm
ENV REDIS_ALARM_DB=4
ENV REDIS_ALARM_HOST=kunda-redis
ENV REDIS_ALARM_PORT=6379
ENV REDIS_ALARM_PASSWORD=
ENV REDIS_ALARM_KEY_PREFIX=kunda-alarm-
